...
- "reason": If inappropriate, explain why. If appropriate, use "Content is appropriate"
- "category": If inappropriate, the specific category from the list above. If appropriate, use "Safe"

Examples:
- Inappropriate: {"reason": "Request asks for help with illegal hacking activities", "category": "Illegal Activities"}
- Appropriate: {"reason": "Content is appropriate", "category": "Safe"}

Analyze the user's request and respond with the JSON object only."""
