...
Analyze the user request and respond with EXACTLY ONE of these two values:
...
Based on the conversation history and current request, which agent should handle this?"""
...
## Current Legal Question/Request:
{user_input}

Please provide a comprehensive legal analysis based on the conversation history and current request. Consider any previous legal topics discussed to provide contextual and relevant information."""
